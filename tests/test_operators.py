...
def test_sigmoid(a: float) -> None:
    ...
    * It is  strictly increasing.
    ...
    assert (1 - sigmoid(a)) - sigmoid(-a) < 1e-6
...
def test_other(a: float) -> None:
    ...
    """
    # TODO: Implement for Task 0.2.
    # Test ReLU function properties: ReLU(x) >= 0 and ReLU(x) <= max(0, x)
    assert relu(a) >= 0.0
    assert relu(a) == max(0.0, a)
    # Test identity function property: id(x) == x
    assert id(a) == a
